        ...
        <div class="bottom">
            ...
            <el-col :span="8" v-for="(found, index) in founds" :key="index" >
                ...
                <div style="padding: 14px;">
                    ...
                    <el-button type="text" class="button" @click="renling(index)">认领</el-button>
                    </div>
                </div>
                </el-card>
            </el-col>
        ...
        <el-dialog
            ...
            <div>
                <el-form :rules="rules" ref="empForm" :model="emp" >
                    ...
                    <el-col :span="4">
                            <el-form-item label="拾取地点:" prop="pickPlace">
                            <span>{{emp.pickPlace}}</span>
                            </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="拾取时间:" prop="pickTime">
                               <span>{{emp.pickTime}}</span>
                                </el-form-item>
                        </el-col>
                    ...
                    <el-col :span="4">
                        <el-form-item label="详细描述:" prop="describe">
                                    <span>{{emp.foundDescribe}}</span>
                                    </el-form-item>
                            </el-col>
                            
                            <el-col :span="4">
                        <el-form-item label="图片:" prop="picPath">
                                    <img v-if="emp.picPath" :src="require('../../assets/found/'+emp.picPath)" style="width:390px;height:380px">
                                    </el-form-item>
                            </el-col>
                    </el-row>
...
//             })
    ...
    searchByTime(index){
            ...
            axios({
                method:'get',
                url:'http://localhost:8083/system/item/found/searchFoundByPicTime?picTime='+this.searchTime
            }).then(res=>{
                if(res.data){         
    ...
    selectTrigger(index){
          axios({
                method:'get',
                url:'http://localhost:8083/system/item/found/searchFoundByType?typeId='+index
            }).then(res=>{
                if(res.data){         
                    this.founds=res.data; 
                }
    ...
    initFounds(){
        axios({
                ...
                if(res.data){         
                    ...
                    //    console.log(this.founds[i].picPath);
                    // }
    ...
    searchFound(){
         axios({
                method:'get',
                url:'http://localhost:8083/system/item/found/searchFound?itemName='+this.name,
